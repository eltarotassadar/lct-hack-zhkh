...
## Демонстрация работы
- Аналитическая панель «HydroPulse Insight»: выбор района, отображение телеметрии и прогнозов риска.
- Каталог узлов учета с фильтрацией и выбором нескольких объектов .

![Демонстрация работы](video/description.gif)
